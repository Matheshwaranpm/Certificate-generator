...
import { Share2, Edit, Copy, Check, Eye, Download, Search } from "lucide-react"
import { useToast } from "@/hooks/use-toast"
import { generateOfferLetterPDF } from "@/components/offer-letter-template"
...
export default function PhysicalOfferPage() {
  ...
  const handleDownloadOffer = async (candidate: Candidate) => {
    try {
      toast({
        title: "Generating Offer Letter",
        description: "Please wait while we prepare your document...",
      })

      // Generate the PDF in background
      await generateOfferLetterPDF(candidate)

      toast({
        title: "Offer Letter Generated",
        description: `Offer letter for ${candidate.name} has been generated and is ready for download/print`,
      })
    } catch (error) {
      toast({
        title: "Error",
    ...
    <main className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-4xl font-bold mb-2">Physical Offer</h1>
                      ...
                      <TableCell className="text-right">
                        {candidate.status === "filled" && (
                          <div className="flex gap-2 justify-end flex-wrap">
                            ...
                            <Button
                              size="sm"
                              onClick={() => handleDownloadOffer(candidate)}
